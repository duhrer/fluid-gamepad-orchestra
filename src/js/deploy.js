...
fluid.registerNamespace("fluid.gamepad.orchestra.generator");

fluid.gamepad.orchestra.generator.makeBundle = function (that) {
...
fluid.defaults("fluid.gamepad.orchestra.generator", {
    gradeNames: ["fluid.component"],
    baseDir: "%fluid-gamepad-orchestra",
    targetDir: "/Users/duhrer/Source/projects/duhrer.github.io/demos/fluid-gamepad-orchestra",
    bundle: [
        "./src",
        "./examples",
    ...
    listeners: {
        "onCreate.createBundle": {
            funcName: "fluid.gamepad.orchestra.generator.makeBundle",
            args:     ["{that}"]
        }
    }
});

fluid.gamepad.orchestra.generator();
